from pyFHE.trgsw import trgswfftSymEncrypt,trgswfftExternalProdcut
...
for i in range(100):
    ...
    A = trgswfftSymEncrypt(np.append([1],np.zeros(sk.params.N - 1)),sk.params.bkalpha,sk.params.h,sk.key.trlwe,sk.params.twist)
    y = trgswfftExternalProdcut(A,x,sk.params)
